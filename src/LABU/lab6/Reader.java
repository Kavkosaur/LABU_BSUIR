...
public class Reader extends JFrame {
    ...
    File file = new File("C:\\Users\\HP\\Desktop\\St.txt");
        ...
        public void actionPerformed(ActionEvent e) {
            try{
                ...
                try{
                    ...
                    out.write(area2 + "\n");
                    if(k == 1)
                        out.write("Продажа игрушки осуществляется без скидки. " + "\n");
                    else if(k == -1)
                        out.write("Продажа игрушки осуществляется со скидкой. " + "\n");
